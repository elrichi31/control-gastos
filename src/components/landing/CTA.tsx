  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl p-12 md:p-16 text-center shadow-2xl shadow-blue-500/25">
          {/* Badge */}
          ...
          <Link href="/auth/register">
            <Button 
              size="lg" 
              className="bg-white text-blue-600 hover:bg-blue-50 text-lg px-10 py-6 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group font-semibold"
            >
