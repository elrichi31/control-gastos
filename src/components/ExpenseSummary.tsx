    ...
    return (
        <Card className="bg-card border-border">
            <CardHeader>
                ...
                <CardDescription>Gastos totales en un rango de fechas</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            <label className="text-sm font-medium text-muted-foreground">Filtrar por fechas</label>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Select value={groupBy} onValueChange={(val) => handleGroupByChange(val as "dia" | "semana" | "mes")}>
                                <SelectTrigger className="w-[120px] h-8 text-sm bg-muted border-border">
                    ...
                    <div className="border-t border-border pt-4">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">{expenses.length} gastos filtrados</p>
                    </div>
                </div>
            </CardContent>
        </Card>
