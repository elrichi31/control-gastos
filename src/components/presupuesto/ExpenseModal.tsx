...
const ExpenseModal: React.FC<ExpenseModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white dark:bg-neutral-900 mx-4 max-w-md backdrop-blur-md">
        <DialogHeader>
        ...
        <form className="space-y-4" onSubmit={editingExpense ? handleUpdateExpense : handleAddExpense}>
          <div className="grid grid-cols-1 gap-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-gray-300 dark:border-neutral-600 dark:bg-neutral-900 dark:text-white rounded-md shadow-sm focus:ring focus:ring-blue-500 focus:outline-none px-3 py-2"
          ...
          <div className="flex gap-2 pt-4">
            ...
            <Button
              type="button"
              variant="outline"
              className="bg-white dark:bg-neutral-900 dark:border-neutral-600 dark:text-gray-300"
              onClick={onCancel}
            >
              Cancelar
            </Button>
