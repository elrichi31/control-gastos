...
import { Expense, GroupByPeriod, formatCurrency } from "@entities/expense"

interface ExpenseSummaryProps {
  expenses: Expense[]
  onDateRangeChange: (range: { from: string; to: string }, groupBy: GroupByPeriod) => void
  groupBy: GroupByPeriod
  setGroupBy: (value: GroupByPeriod) => void
}
...
export function ExpenseSummary({
  ...
  const handleGroupByChange = (value: GroupByPeriod) => {
    setGroupBy(value)
